...
/**
 * services for reading, adding, changing and deleting journeys
 */
@Path("journey")
public class Journeyservice {
    ...
    /**
     * reads a journey identified by the uuid
    ...
    /**
     * deletes a journey identified by its uuid
     * @param journeyUUID  the key
     * @return  Response
     */
    @RolesAllowed("admin")
